...
const Faq = () => {
  ...
  return (
    <>
      <section className="pb-20 md:pb-28 lg:pb-[180px] pt-[100px] lg:pt-[180px] mb-[80px] lg:mb-0">
        <div className="max-w-[768px] mx-auto lg:bg-faq bg-no-repeat bg-custom bg-center lg:min-h-[1160px] lg:pt-6">
          ...
          <div
            ...
            data-aos-offset="200"
            data-aos-delay="200"
            className="flex items-center mb-[50px] lg:mb-20 justify-start lg:justify-center -space-x-4 lg:max-w-[540px] mx-auto px-4 lg:px-0"
          >
