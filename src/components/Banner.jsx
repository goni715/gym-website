             ...
             <div className="container lg:px-[7rem] h-full">
                <div className="flex items-center h-full relative -space-x-48 lg:-space-x-24 pl-6 lg:pl-0">
                    ...
                    <div className="text-white flex-1 z-10">
                        ...
                        <button className="flex justify-center items-center rounded-[1px] font-primary font-bold uppercase text-[12px] lg:text-[14px] leading-[18px] h-[42px] lg:h-[46px] px-[30px] lg:px-[40px] tracking-[1px] bg-white text-neutral-500 hover:bg-white/90 transition">
                            {textBtn}
                        </button>
                    </div>
